...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-crg-jac.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-crg-jac.containers.anotherwebservice.com/
...
```
git clone git@github.com:tzepesh7/container-crg-jac.git
cd container-crg-jac
```
...
```
docker attach container-crg-jac
```
